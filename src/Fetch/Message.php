...
class Message
{
    ...
    protected function processStructure($structure, $partIdentifier = null)
    {
        ...
        if ((isset($parameters['name']) || isset($parameters['filename']) || isset($parameters['filename*']))
            ...
            if (strtolower($structure->subtype) === 'plain' || ($structure->type == 1 && !in_array(strtolower($structure->subtype), ['alternative', 'related', 'mixed']))) {
